...
<a id="replayreproducibility-evidence--log-only"></a>

#### `replay/reproducibility-evidence` — log-only
...
来源： [`packages/core/tools/src/types.ts:54`](../packages/core/tools/src/types.ts)
